...
def levDist(vv1, vv2):
	...
	for i in xrange(lv1):
		...
		if (l1 != 0) and (l2 != 0): # both non-empty
			emptyflag = False
			dis = lvst.distance(t1.lower(), t2.lower())
			if (dis > thr):
				return False
...
if __name__ == '__main__':
	...
	flist = [[0], [3, 1], [3, 5], [3, 7], [3, 8], [3, 9]] # the best one
	...
	matchFuncList = [indexMatch, matchTitleAuthor, levDist, matchTitlePublisher, matchTitleYear, matchTitlePages] # the best one
